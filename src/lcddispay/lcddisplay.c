 ...
 * \brief: D - 1, C - 1, B - 0
 */
#define LCD_DISPAY_CONTROL_CMD 0x0E 
...
{
#ifdef LCD_8_BIT_MODE
    DIO_ConfigurePin(LCD_D0,    CP_A, CP_0, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_D1,    CP_A, CP_1, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_D2,    CP_A, CP_2, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_D3,    CP_A, CP_3, CP_R, CP_OFF, CP_WR);
#endif
    DIO_ConfigurePin(LCD_D4,    CP_A, CP_4, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_D5,    CP_A, CP_5, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_D6,    CP_A, CP_6, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_D7,    CP_A, CP_7, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_RS,    CP_B, CP_2, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_E,     CP_B, CP_1, CP_R, CP_OFF, CP_WR);
    DIO_ConfigurePin(LCD_BL,    CP_B, CP_0, CP_R, CP_OFF, CP_WR);
